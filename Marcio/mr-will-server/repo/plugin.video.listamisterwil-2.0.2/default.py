...
addon = xbmcaddon.Addon('plugin.video.listamisterwil-2.0.2')
...
CHBase = base64.decodestring('aHR0cHM6Ly9kbC13ZWIubWVvY2xvdWQucHQvZGx3ZWIvZG93bmxvYWQvTWlzdGVyL2Jla2EvQ2FuYWlzJTIwZG8lMjBhZGRvbi54bWw/cHVibGljPWY4NDBkOTgyLTg3NjItNGZjYS04YmM3LTA2ZDZmMzEyNmIyZA==')
...
def addon_log(string):
    if debug == 'true':
        xbmc.log("[addon.listamisterwil-%s]: %s" %(addon_version, string))
...
#                print 'setting as folder in link'
        ...
        if showcontext:
            ...
            if showcontext == 'fav':
                ...
                contextMenu.append(('Add to Mr-Wil-Stream Favorites','XBMC.RunPlugin(%s)' %fav_params))
            liz.addContextMenuItems(contextMenu)
