...
Jogo1 = "Ar.bat"
dir_C = xbmc.translatePath("special://home/addons/plugin.program.arkanoid/game/Arkanoid/")
EMUWin = xbmc.translatePath("special://home/addons/plugin.program.arkanoid/SO/Win/DOSBoxPortable/DOSBoxPortable.exe")
File_Win = xbmc.translatePath("special://home/addons/plugin.program.arkanoid/SO/Win/DOSBoxPortable/Data/settings/dosbox.conf")
File_Linux =xbmc.translatePath("special://home/addons/plugin.program.arkanoid/arka")
...
def index():
    ...
    addDir("Arkanoid",Jogo1, 'showSite', os.path.join(addonPath, "icon.png"), "yes", "yes")
...
def showSite(url, stopPlayback, kiosk, userAgent):
    ...
    if osWin:
        ...
        arquivo = open(''+File_Win+'', 'a')
        arquivo.write('\n')
        arquivo.write('mount c '+dir_C+'')
        arquivo.write('\n')
        arquivo.write('C:')
        arquivo.write('\n')
        arquivo.write(''+Jogo1+'')
