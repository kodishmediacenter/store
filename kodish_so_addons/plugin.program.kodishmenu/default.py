...
hb = "/usr/bin/ghb"
cdrip = "/usr/bin/asunder"
spotify = "/usr/bin/spotify" 
chrome  = "/usr/bin/google-chrome-stable"
stremium = "/opt/kodish/Stremio-runtime/Stremio-runtime"
...
def index():
    ...
    addDir(" Ripador DVD ", hb, 'showSite', os.path.join(addonPath, "dvdrip.jpg"), "yes", "yes")
    addDir(" Ripador CD  ", cdrip, 'showSite', os.path.join(addonPath, "ripcd.jpg"), "yes", "yes")
    addDir(" Spotify  ", spotify, 'showSite', os.path.join(addonPath, "spotify.jpg"), "yes", "yes")
    addDir(" Web Browser ", chrome, 'showSite', os.path.join(addonPath, "chromium.png"), "yes", "yes") 
    addDir(" Stremio ", stremium, 'showSite', os.path.join(addonPath, "stremio.png"), "yes", "yes") 
...
def getFullPath(path, url, useKiosk, userAgent):
    ...
    urlb ="http://google.com"
    black_background = os.path.join(userDataFolder, "black.html")
    with open(black_background, "w") as launch:
        launch.write('<html><body style="background:black"><script>window.location.href = "%s";</script></body></html>' % urlb)
