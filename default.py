...
def PlayUrlMod(name,url,iconImage=None):
	agent = "|User-Agent=Mozilla/5.0 (Windows NT 10.0; WOW64; rv:47.0) Gecko/20100101 Firefox/47.0"
	urlb = ""+url+""+agent+""
	PlayUrl(name, urlb, iconimage=None)
